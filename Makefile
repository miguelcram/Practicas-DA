...
HISTORIAL = ../$(BASE_DIR)/simulador/historial
GUION_P0 = guion-p0
GUION_P1 = guion-p1
GUION_P2 = guion-p2
GUION_P3 = guion-p3
...
BIN_HISTORIAL = ../$(BASE_DIR)/simulador/historial
...
FILES_TO_PACK_P3 = ../$(BASE_DIR)/p3/cronometro.h ../$(BASE_DIR)/p3/DefenseStrategy.example.cpp ../$(BASE_DIR)/p3/e*.tex ../$(BASE_DIR)/p3/p3.tex ../$(BASE_DIR)/p3/guion-p3.pdf ../$(BASE_DIR)/p3/Makefile ../$(BASE_DIR)/p3/graphic.plot $(BIN_P3)
...
SOURCES_P4 = $(FILES_TO_PACK_P4) $(FILES_TO_PACK_P4_SOL) ../$(BASE_DIR)/p4/guion-p4.tex ../$(BASE_DIR)/competicion/p4/competicion.sh ../$(BASE_DIR)/competicion/p4/resultados.xls ../$(BASE_DIR)/competicion/p4/copias.sh

# ============================ RULES ===========================================

.PHONY: all
all: p0 p1 p2 p3 p4 $(EXE) $(HISTORIAL)
...
$(HISTORIAL): simulador/CodingManager.cpp simulador/CodingManager.h simulador/historial.cpp 

	cd simulador; g++ -o historial historial.cpp CodingManager.cpp ; cd ..
...
publish:
	rm -f $(TAR_NAME).tar.gz; tar -czvf $(TAR_NAME).tar.gz $(FILES_TO_PACK_SIMULADOR) $(FILES_TO_PACK_VISOR) $(FILES_TO_PACK_P0) $(FILES_TO_PACK_P1) $(FILES_TO_PACK_P2) $(FILES_TO_PACK_P3) $(FILES_TO_PACK_P4) $(FILES_TO_PACK_OTHERS)

publishminimal:
	rm -f $(TAR_NAME).tar.gz; tar -czvf $(TAR_NAME).tar.gz $(FILES_TO_PACK_SIMULADOR) $(FILES_TO_PACK_P0) $(FILES_TO_PACK_P1) $(FILES_TO_PACK_P2) $(FILES_TO_PACK_P3) $(FILES_TO_PACK_P4) $(FILES_TO_PACK_OTHERS)

bin:
	rm -f $(TAR_NAME)-bin.tar.gz; tar -czvf $(TAR_NAME)-bin.tar.gz $(BIN_SIMULADOR) $(BIN_HISTORIAL) $(BIN_P1) $(BIN_P2) $(BIN_P3) $(BIN_P4)

solutions:
	rm -f $(TAR_NAME)-soluciones.tar.gz; tar -czvf $(TAR_NAME)-soluciones.tar.gz $(FILES_TO_PACK_P1_SOL) $(FILES_TO_PACK_P2_SOL) $(FILES_TO_PACK_P3_SOL) $(FILES_TO_PACK_P4_SOL)

sources:
	rm -f $(TAR_NAME)-sources.tar.gz; tar -czvf $(TAR_NAME)-sources.tar.gz $(SOURCES_SIMULADOR) $(SOURCES_VISOR) $(SOURCES_OTHERS) $(SOURCES_P0) $(SOURCES_P1) $(SOURCES_P2) $(SOURCES_P3) $(SOURCES_P4)
